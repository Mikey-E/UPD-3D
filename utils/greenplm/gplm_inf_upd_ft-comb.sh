...
CUDA_VISIBLE_DEVICES=0 python gplm_inf_upd.py \
    ...
    --pc_ckpt_path /cluster/medbow/project/3dllms/melgin/GreenPLM_ft-comb/checkpoints/stage_3_Crops3D_gpt-5-nano/checkpoint-9000/global_step9000/mp_rank_00_model_states.pt \
