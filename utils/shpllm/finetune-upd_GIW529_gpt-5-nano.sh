...
if [ $type = "general" ]; then
    meta_path="./playground/data/upd_GIW529_gpt-5-nano/cap3d_objaverse_sft_45k.json"
    pcs_path="./playground/data/upd_GIW529_gpt-5-nano/cap3d_pcs"
elif [ $type = "gapartnet" ]; then
    meta_path="./playground/data/upd_GIW529_gpt-5-nano/gapartnet_sft_27k_openai.json"
    pcs_path="./playground/data/upd_GIW529_gpt-5-nano/gapartnet_pcs"
else
    echo "Unknown type"
    exit 1
fi
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/$MODEL_VERSION-$type-$TAG-finetune-upd_GIW529_gpt-5-nano \
    --num_train_epochs 1 \
