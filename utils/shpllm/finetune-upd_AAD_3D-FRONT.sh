...
if [ $type = "general" ]; then
    meta_path="./playground/data/upd_AAD_3D-FRONT/cap3d_objaverse_sft_45k.json"
    pcs_path="./playground/data/upd_AAD_3D-FRONT/cap3d_pcs"
elif [ $type = "gapartnet" ]; then
    meta_path="./playground/data/upd_AAD_3D-FRONT/gapartnet_sft_27k_openai.json"
    pcs_path="./playground/data/upd_AAD_3D-FRONT/gapartnet_pcs"
else
    echo "Unknown type"
    exit 1
fi
...
deepspeed llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/$MODEL_VERSION-$type-$TAG-finetune-upd_AAD_3D-FRONT \
    --num_train_epochs 1 \
