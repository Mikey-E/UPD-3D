...
#SBATCH --job-name=mgpt3d_train_stage4
#SBATCH --output=mgpt3d_train_stage4_%j.out
#SBATCH --error=mgpt3d_train_stage4_%j.out
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
...
CUDA_VISIBLE_DEVICES=0 python train.py --cfg-path ./train_configs/MiniGPT_3D/mgpt3d_stage_4_combined.yaml