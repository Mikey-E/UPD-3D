...
#SBATCH --output=./slurm_logs/mgpt3d_train_stage1_combined_%j.out
#SBATCH --error=./slurm_logs/mgpt3d_train_stage1_combined_%j.out
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
CUDA_VISIBLE_DEVICES=0 python train.py --cfg-path ./train_configs/MiniGPT_3D/mgpt3d_train-config_stage1_combined.yaml